...
CACHE_DIR = base_dir+"/data/cache/stocks_day_k"
os.makedirs(CACHE_DIR, exist_ok=True)



trades = pd.read_csv(base_dir+"/data/processed/trades_clean_v2.csv")
...
for s in indexes:
    ...
    df.to_csv(base_dir+f"/data/cache/index/{name}_day_k.csv", index=False)